...
function scene:create( event )
	...
	background.fill = {
		type = "image",
		filename = "image/background/수화연못.png"
	}
	...
	local support = display.newRect(display.contentWidth * 0.8, display.contentHeight * 0.5, 255, 455)
	...
	local img = display.newRect(display.contentWidth * 0.2, display.contentHeight * 0.45, 255, 455)
	img.alpha = 0
	...
	-- json에서 정보 읽기
	local Data = jsonParse("json/8.json")
