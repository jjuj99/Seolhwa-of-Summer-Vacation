...
function scene:create( event )
	...
	cloud[1] = display.newImageRect("image/game_ascension/phase4/열권구름1.png", 130, 70)
	cloud[1].x, cloud[1].y = 850, 600
	-- cloud[1]:scale(0.4, 0.4)

	cloud[2] = display.newImageRect("image/game_ascension/phase4/열권구름2.png", 130, 70)
	cloud[2].x, cloud[2].y = 650, 500
	-- cloud[2]:scale(0.4, 0.4)

	cloud[3] = display.newImageRect("image/game_ascension/phase4/열권구름3.png", 130, 70)
	cloud[3].x, cloud[3].y = 800, 400
	-- cloud[3]:scale(0.4, 0.4)

	cloud[4] = display.newImageRect("image/game_ascension/phase4/열권구름4.png", 130, 70)
	cloud[4].x, cloud[4].y = 600, 300
	-- cloud[4]:scale(0.4, 0.4)

	cloud[5] = display.newImageRect("image/game_ascension/phase4/열권구름5.png", 130, 70)
	cloud[5].x, cloud[5].y = 400, 200
		...
		if(event.phase == "ended" and flag == false) then
			if(event.other.name == "up") then
				...
				timer.performWithDelay(1, function()
										...
										composer.gotoScene('game_ascension.phase_clear')
									end, 1)
	...
	function set:tap( event )
		...
		composer.setVariable("phase", "phase4_2")
