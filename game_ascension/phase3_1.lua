...
function scene:create( event )
	...
	-- 배경 --
	local background = display.newImageRect("image/game_ascension/background/하늘5.jpg", display.contentWidth, display.contentHeight)
	...
	-- 점프하세요 이미지 --
	local jumpImg = display.newImage("image/game_ascension/JUMP(흰+그림자).png")
	jumpImg.x, jumpImg.y = 480, 160
	...
	eming.x, eming.y = display.contentCenterX, 560
	...
	function set:tap( event )
		...
		composer.setVariable("phase", "phase3_1")
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('game_ascension.phase3_1')
