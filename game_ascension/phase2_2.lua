...
function scene:create( event )
	...
	cloud[1] = display.newImage("image/game_ascension/phase2/성층권구름.png")
	cloud[1].x, cloud[1].y = 450, 650
	-- cloud[1]:scale(0.4, 0.4)

	cloud[2] = display.newImage("image/game_ascension/phase2/성층권구름.png")
	cloud[2].x, cloud[2].y = 800, 550
	-- cloud[2]:scale(0.4, 0.4)

	cloud[3] = display.newImage("image/game_ascension/phase2/성층권구름.png")
	cloud[3].x, cloud[3].y = 550, 400
	-- cloud[3]:scale(0.4, 0.4)

	cloud[4] = display.newImage("image/game_ascension/phase2/성층권구름.png")
	cloud[4].x, cloud[4].y = 900, 300
	-- cloud[4]:scale(0.4, 0.4)

	cloud[5] = display.newImage("image/game_ascension/phase2/성층권구름.png")
	...
	function set:tap( event )
		...
		composer.setVariable("phase", "phase2_2")
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('game_ascension.phase2_2')
