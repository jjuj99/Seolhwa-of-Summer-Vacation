...
function scene:create( event )
		...
		if(event.phase == "ended" and flag == false) then
			if(event.other.name == "up") then
				...
				timer.performWithDelay(1, function()
										...
										composer.gotoScene('game_ascension.phase4_2')
									end, 1)
			...
			elseif(event.other.name == "down") then
				...
				timer.performWithDelay(1, function()
										...
										composer.gotoScene('game_ascension.phase3_2')
									end, 1)
	...
	function set:tap( event )
		...
		composer.setVariable("phase", "phase4_1")
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('game_ascension.phase4_1')
