...
function scene:create( event )
	...
	-- 배경 --
	local background = display.newImageRect("image/game_ascension/background/하늘7.jpg", display.contentWidth, display.contentHeight)
	...
	cloud[5] = display.newImageRect("image/game_ascension/열권구름.png", 130, 80)
