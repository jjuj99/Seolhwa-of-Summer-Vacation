...
function scene:create( event )
	...
	cloud[1] = display.newImageRect("image/game_ascension/phase1/중간구름1.png", 200, 100)
	cloud[1].x, cloud[1].y = 500, 650
	-- cloud[1]:scale(0.4, 0.4)

	cloud[2] = display.newImageRect("image/game_ascension/phase1/중간구름2.png", 200, 100)
	cloud[2].x, cloud[2].y = 750, 530
	-- cloud[2]:scale(0.4, 0.4)

	cloud[3] = display.newImageRect("image/game_ascension/phase1/중간구름3.png", 200, 100)
	cloud[3].x, cloud[3].y = 950, 450
	-- cloud[3]:scale(0.4, 0.4)

	cloud[4] = display.newImageRect("image/game_ascension/phase1/중간구름4.png", 200, 100)
	cloud[4].x, cloud[4].y = 780, 320
	-- cloud[4]:scale(0.4, 0.4)

	cloud[5] = display.newImageRect("image/game_ascension/phase1/중간구름5.png", 200, 100)
		...
		if(event.phase == "ended" and flag == false) then
			if(event.other.name == "up") then
				...
				timer.performWithDelay(1, function()
										...
										composer.gotoScene('game_ascension.phase2_1')
									end, 1)
			...
			elseif(event.other.name == "down") then
				...
				timer.performWithDelay(1, function()
										...
										composer.setVariable("start", "down")
	...
	function set:tap( event )
		...
		composer.setVariable("phase", "phase1_2")
		composer.setVariable("eming", eming)
		composer.setVariable("ground", ground)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('game_ascension.phase1_2')
